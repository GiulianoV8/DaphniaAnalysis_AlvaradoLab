...
# How to use
[TRex}(https://doi.org/10.7554/eLife.64000) tracking produced csvs with columns [X,Y,Time]
## INPUTS
...
## EXAMPLE Call
`
[Op, Or] = plotCollectiveBehaviorOpOr( ...'AItracking20minutes','C:\Users\vrspr\Videos\Organism_Motion_Data\AItracking20minutes_csv', 30, 3, 500, [-1000, -1000], 60, 1200);
`
